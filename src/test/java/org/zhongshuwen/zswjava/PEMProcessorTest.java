...
public class PEMProcessorTest {
    ...
    */
    ...
    public void validatePublicKeyExtractionFromPrivateKey(){
        ...
        try {
            PEMProcessor pemProcessor1 = new PEMProcessor(ZSWFormatter.convertZSWPrivateKeyToPEMFormat(privateKey1));
            assertEquals(publicKey1, pemProcessor1.extractZSWPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor2 = new PEMProcessor(ZSWFormatter.convertZSWPrivateKeyToPEMFormat(privateKey2));
            assertEquals(publicKey2, pemProcessor2.extractZSWPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor3 = new PEMProcessor(ZSWFormatter.convertZSWPrivateKeyToPEMFormat(privateKey3));
            assertEquals(publicKey3, pemProcessor3.extractZSWPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor4 = new PEMProcessor(ZSWFormatter.convertZSWPrivateKeyToPEMFormat(privateKey4));
            assertEquals(publicKey4, pemProcessor4.extractZSWPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor5 = new PEMProcessor(ZSWFormatter.convertZSWPrivateKeyToPEMFormat(privateKey5));
            assertEquals(publicKey5, pemProcessor5.extractZSWPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor6 = new PEMProcessor(ZSWFormatter.convertZSWPrivateKeyToPEMFormat(privateKey6));
            assertEquals(publicKey6, pemProcessor6.extractZSWPublicKeyFromPrivateKey(false));
