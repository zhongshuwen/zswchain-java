...
public class TransactionProcessorTest {
    ...
    public void isAllowTransactionToBeModified() {
        ...
        this.mockAbiProvider(ZSWCHAINTOKENABIJSON);
    ...
    public void prepareWithOverrideActions() {
        ...
        try {
            ...
            newActions.add(new Action("zswhq.create", "create", authorizations, jsonData));
        ...
        Transaction transaction = processor.getTransaction();
        assertNotNull(transaction);
        assertEquals("zswhq.create", transaction.getActions().get(0).getAccount());
    ...
    private void mockDefaultSuccessData() {
        ...
        this.mockSerializationProvider(MOCKED_ACTION_HEX, MOCKED_TRANSACTION_HEX, mockedDeserilizedTransaction);
        this.mockSignatureProvider(Arrays.asList("Key1", "Key2"),
                Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN).fromJson(mockedZswChainTransactionSignatureResponseJSON, ZswChainTransactionSignatureResponse.class));
    }
    ...
    private List<Action> defaultContextFreeActions(boolean addData) {
        ...
        List<Action> actions = new ArrayList<>();
        actions.add(new Action("zswhq.token", "transfer", new ArrayList<Authorization>(), jsonData, true));
    ...
    private void mockSignatureProvider(List<String> mockedAvaialbleKeys, ZswChainTransactionSignatureResponse mockedResponse) {
        try {
