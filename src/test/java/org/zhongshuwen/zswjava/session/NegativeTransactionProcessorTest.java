...
/*
    ...
    public void prepare_thenFailWithGetInfoError() throws TransactionPrepareError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(GetInfoRpcError.class));
    ...
    public void prepare_thenFailWithGetBlockError() throws TransactionPrepareError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(GetBlockInfoRpcError.class));
    ...
    public void signCallSerialize_thenFailWithGetAbiError() throws TransactionSignError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(TransactionCreateSignatureRequestError.class));
        ...
        // Mock ABI provider
        try {
            when(this.mockedABIProvider.getAbi(any(String.class), any(ZSWName.class))).thenThrow(new GetAbiError());
    ...
    public void signCallCreateSignature_thenFailWithGetAvailableKeyError() throws TransactionSignError {
        exceptionRule.expect(TransactionSignError.class);
        exceptionRule.expectMessage(ErrorConstants.TRANSACTION_PROCESSOR_SIGN_CREATE_SIGN_REQUEST_ERROR);
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(TransactionCreateSignatureRequestKeyError.class));
        ...
        // Mock AbiProvider
        this.mockGetAbi(ZSWCHAINTOKENABIJSON);
    ...
    public void signCallGetSignature_thenFailWithEmptySerializedTransactionError()
        ...
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(
        ...
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedEmptyTransactionSignatureResponseJSON, ZswChainTransactionSignatureResponse.class));
    ...
    public void signCallGetSignature_thenFailWithEmptySignatureError()
        ...
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedEmptySignaturesSignatureResponseJSON, ZswChainTransactionSignatureResponse.class));
    ...
    public void signCallGetSignatureWithTransactionModified_thenFailWithDeserializeTransactionError()
        ...
        this.mockGetAvailableKey(Arrays.asList("Key1", "Key2"));
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedZswChainTransactionSignatureResponseModifiedTransactionJSON, ZswChainTransactionSignatureResponse.class));
    ...
    public void broadCast_thenFailWithSendTransactionError() throws TransactionBroadCastError {
        ...
        this.mockGetAvailableKey(Arrays.asList("Key1", "Key2"));
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedZswChainTransactionSignatureResponseJSON, ZswChainTransactionSignatureResponse.class));
    ...
    private void mockSignTransaction(ZswChainTransactionSignatureResponse mockedResponse) {
        try {
            when(this.mockedSignatureProvider.signTransaction(any(ZswChainTransactionSignatureRequest.class))).thenReturn(mockedResponse);
    ...
    private void mockGetAbi(String abiJSON) {
        try {
            when(this.mockedABIProvider.getAbi(any(String.class), any(ZSWName.class))).thenReturn(abiJSON);
        } catch (GetAbiError getAbiError) {
            getAbiError.printStackTrace();
            fail("Exception should not be thrown here for mocking getAbi");
        }
