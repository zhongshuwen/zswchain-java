...
//@PrepareForTest(ZSWFormatter.class)
//@SuppressStaticInitializationFor("org.zhongshuwen.zswjava.utilities.ZSWFormatter") // <-- this is it :)
...
public class SoftKeySignatureProviderImplTest {
    ...
    public void importKeyR1Test() {
        String privateKeyZSW = "PVT_R1_g6vV9tiGqN3LkhD53pVUbxDn76PuVeR6XfmJzrnLR3PbGWLys";
        String publicKeyZSW = "PUB_R1_71AYFp3Aasa2od6bwmXEQ13MMfqv4wuJwCRx1Z1dbRifrQEqZt";

        SoftKeySignatureProviderImpl provider = new SoftKeySignatureProviderImpl();

        try {
            provider.importKey(privateKeyZSW);
            List<String> keys = provider.getAvailableKeys();
            assertEquals(1, keys.size());
            assertEquals(publicKeyZSW, keys.get(0));
    ...
    public void importKeyK1Test() {
        String privateKeyZSW = "5JKVeYzRs42DpnHU1rUeJHPZyXb1pCdhyayx7FD2qKHV63F71zU";
        String publicKeyZSWLegacy = "EOS8CbY5PhQZGF2gzPKRBaNG4YzB4AwpmfnDcVZMSPZTqQMiGxPbF";
        String publicKeyZSW = "PUB_K1_8CbY5PhQZGF2gzPKRBaNG4YzB4AwpmfnDcVZMSPZTqQMn1uFhB";
        SoftKeySignatureProviderImpl provider = new SoftKeySignatureProviderImpl();
        ...
        try {
            ...
            assertTrue(keys.contains(publicKeyZSW));
            assertTrue(keys.contains(publicKeyZSWLegacy));
        } catch (ImportKeyError importKeyError) {
            importKeyError.printStackTrace();
            fail("Should not throw error!!!!");
        } catch (GetAvailableKeysError getAvailableKeysError) {
    ...
    public void getAvailableKeyTest() {
        String privateKeyK1ZSW = "5JKVeYzRs42DpnHU1rUeJHPZyXb1pCdhyayx7FD2qKHV63F71zU";
        String privateKeyR1ZSW = "PVT_R1_g6vV9tiGqN3LkhD53pVUbxDn76PuVeR6XfmJzrnLR3PbGWLys";
        String publicKeyR1ZSW = "PUB_R1_71AYFp3Aasa2od6bwmXEQ13MMfqv4wuJwCRx1Z1dbRifrQEqZt";
        String publicKeyK1ZSW = "PUB_K1_8CbY5PhQZGF2gzPKRBaNG4YzB4AwpmfnDcVZMSPZTqQMn1uFhB";
        String publicKeyK1ZSWLegacy = "EOS8CbY5PhQZGF2gzPKRBaNG4YzB4AwpmfnDcVZMSPZTqQMiGxPbF";

        SoftKeySignatureProviderImpl provider = new SoftKeySignatureProviderImpl();

        try {
            provider.importKey(privateKeyK1ZSW);
            provider.importKey(privateKeyR1ZSW);
        } catch (ImportKeyError importKeyError) {
            importKeyError.printStackTrace();
            fail("Should not throw error!!!");
        }
        ...
        try {
            ...
            assertTrue(keys.contains(publicKeyK1ZSW));
            assertTrue(keys.contains(publicKeyK1ZSWLegacy));
            assertTrue(keys.contains(publicKeyR1ZSW));
        } catch (GetAvailableKeysError getAvailableKeysError) {
            getAvailableKeysError.printStackTrace();
            fail("Should not throw error!!!");
        }
    ...
    public void signTransactionTest() {
        ...
        List<String> publicKeys = Collections.singletonList(publicKeyR1ZSW);
        String chainId = "687fa513e18843ad3e820744f4ffcf93b1354036d80737db8dc444fe4b15ad17";
        ZswChainTransactionSignatureRequest request = new ZswChainTransactionSignatureRequest(serializedTransaction, publicKeys, chainId, null, false);
        SoftKeySignatureProviderImpl provider = new SoftKeySignatureProviderImpl();
        ...
        try {
            ZswChainTransactionSignatureResponse response = provider.signTransaction(request);
    ...
    public void signTransactionWithMultipleKeyExpectMultiSignatures() {
        ...
        String serializedTransaction = "8BC2A35CF56E6CC25F7F000000000100A6823403EA3055000000572D3CCDCD01000000000000C03400000000A8ED32322A000000000000C034000000000000A682A08601000000000004454F530000000009536F6D657468696E6700";
        List<String> publicKeys = Arrays.asList(publicKeyR1ZSW, publicKeyK1ZSW);
        String chainId = "687fa513e18843ad3e820744f4ffcf93b1354036d80737db8dc444fe4b15ad17";
        ZswChainTransactionSignatureRequest request = new ZswChainTransactionSignatureRequest(serializedTransaction, publicKeys, chainId, null, false);
        SoftKeySignatureProviderImpl provider = new SoftKeySignatureProviderImpl();
    ...
    public void importKey_thenFailConvertToPemError() throws ImportKeyError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(ZSWFormatterError.class));
    ...
    public void getAvailableKey_thenFailConvertFromPemToEosError() throws GetAvailableKeysError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ZswChainError>instanceOf(PEMProcessorError.class));
        ...
        try {
            PowerMockito.mockStatic(ZSWFormatter.class);
            when(ZSWFormatter.encodePublicKey(any(byte[].class), any(AlgorithmEmployed.class), anyBoolean())).thenThrow(new Base58ManipulationError());
...
/*
    ...
    public void signTransactionTest_thenFailWithPrepareSignableTransaction() throws SignTransactionError {
        ...
        try {
            PowerMockito.mockStatic(ZSWFormatter.class);
            when(ZSWFormatter.prepareSerializedTransactionForSigning(any(String.class), any(String.class))).thenThrow(new ZSWFormatterError());
 ...
 */
    ...
    public void signTransactionTest_thenFailKeyNotFound() throws SignTransactionError {
        ...
        exceptionRule.expect(SignTransactionError.class);
        exceptionRule.expectMessage(String.format(SoftKeySignatureErrorConstants.SIGN_TRANS_KEY_NOT_FOUND, publicKeyR1ZSW));
