package org.zhongshuwen.zswabi;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import org.zhongshuwen.zswjava.error.serializationProvider.*;
...
public class AbiTest {
    ...
    private static AbiZswSerializationProviderImpl abieos;
    ...
    public static void startSetup() {
        try {
            abieos = new AbiZswSerializationProviderImpl();
    ...
    public void testHello() throws SerializationProviderError {
        String text = new AbiZswSerializationProviderImpl().stringFromAbiEos();
    ...
    public void jsonToHexNullReturnValueShouldThrowWhenDefaultsToInvalidAction() {
        ...
        try {
            ...
            err.printStackTrace();
            errorThrown = true;
            assertEquals("org.zhongshuwen.zswjava.error.serializationProvider.SerializeError: Unable to find type for action invalid. contract \"contract\" does not have action \"invalid\"", err.getMessage());
        }
    ...
    public void hexToJsonNullReturnValueShouldThrowWhenDefaultsToInvalidAction() {
        ...
        try {
            ...
            err.printStackTrace();
            errorThrown = true;
            assertEquals("org.zhongshuwen.zswjava.error.serializationProvider.DeserializeError: Unable to find type for action invalid. contract \"contract\" does not have action \"invalid\"", err.getMessage());
        }
    ...
    public void testQueryItAnyArrayDeserialization() {
        ...
        try {
            AbiEosSerializationObject serializationObject = new AbiEosSerializationObject(null, "wefqf", returnValueType, QUERY_IT_ABI);
            serializationObject.setHex(hex);
            abieos.deserialize(serializationObject);
            json = serializationObject.getJson();
        } catch (DeserializeError err) {
