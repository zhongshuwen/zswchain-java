...
public class BCECUtil {
    ...
    public static BCECPrivateKey convertECPrivateKeyPEMToBCECPrivateKey(String pemString) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
        return convertPKCS8ToECPrivateKey(convertECPrivateKeyPEMToPKCS8(pemString));
    }
    public static byte[] convertECPrivateKeyPEMToECDBytes(String pemString) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
        return convertPKCS8ToECPrivateKey(convertECPrivateKeyPEMToPKCS8(pemString)).getD().toByteArray();
    }
    public static byte[] convertECPublicKeyPEMToCompressedBasic(String pemString) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
        return convertX509ToECPublicKey(convertECPublicKeyPEMToX509(pemString)).getQ().getEncoded(true);
    }
