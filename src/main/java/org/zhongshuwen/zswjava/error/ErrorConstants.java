...
public class ErrorConstants {
    ...
    //ZSWFormatter() Errors
    /**
     * The private key provided is not in the ZSW format.
     */
    public static final String INVALID_ZSW_PRIVATE_KEY = "The ZSW private key provided is invalid!";
    /**
     * The public key provided is not in the ZSW format.
     */
    public static final String INVALID_ZSW_PUBLIC_KEY = "The ZSW public key provided is invalid!";
    /**
     * An error occurred while Base58 decoding the ZSW key.
     */
    public static final String BASE58_DECODING_ERROR = "An error occurred while Base58 decoding the ZSW key!";
    /**
    ...
    /**
     * Error message get thrown if {@link IABIProvider#getAbi(String, ZSWName)} get error.
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)} returns error
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)} return empty serialized transaction.
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)} return no signature.
     */
    ...
    /**
     * Error message get thrown if {@link ZswChainTransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)} has modified serialized transaction but {@link TransactionProcessor#isTransactionModificationAllowed()} is false
     */
    ...
    /**
     * Error message get thrown if {@link ISerializationProvider#deserializeTransaction} returns error during deserialize modified serialized transaction inside {@link ZswChainTransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)}
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)} return error during process of {@link TransactionProcessor#sign()}
     */
    ...
    /**
     * Error message get thrown if {@link ISerializationProvider#deserializeTransaction} returns empty result during deserialize modified serialized transaction inside {@link ZswChainTransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(ZswChainTransactionSignatureRequest)}
     */
