...
import org.zhongshuwen.zswjava.error.utilities.*;
 ...
 * from formats that are germane to ZSW blockchain transactions and the PEM (Privacy Enhanced Mail)
 * format for those objects.  It also provides methods to format a serialized transaction into a
 * format that can be submitted to an ZSW blockchain.
 */
public class ZSWFormatter {

    /*
    ZSW Format Prefixes - The prefixes below are all used to preface the ZSW format of certain types
    of keys and signatures.  For instance, 'ZSW' is used to preface a legacy form of a public key
    that was generated using the secp256k1 algorithm.  The prefixes and there associated objects are
    as follows:
    ZSW - Public Key generated with secp256k1 algorithm formatted for use on ZSW blockchain.
    PUB_R1_ - Public Key generated with secp256r1 or prime256v1 algorithm formatted for use on ZSW blockchain.
    PUB_K1_ - Public Key generated with secp256k1 algorithm formatted for use on ZSW blockchain.
    PVT_R1_ - Private Key generated with secp256r1 algorithm formatted for use on ZSW blockchain.
     ...
     */
    private static final String PATTERN_STRING_ZSW_PREFIX_ZSW = "EOS";
    private static final String PATTERN_STRING_ZSW_PREFIX_PUB_R1 = "PUB_R1_";
    private static final String PATTERN_STRING_ZSW_PREFIX_PUB_K1 = "PUB_K1_";
    private static final String PATTERN_STRING_ZSW_PREFIX_PUB_GM = "PUB_GM_";
    private static final String PATTERN_STRING_ZSW_PREFIX_PVT_R1 = "PVT_R1_";
    private static final String PATTERN_STRING_ZSW_PREFIX_PVT_GM = "PVT_GM_";

    private static final String PATTERN_STRING_ZSW_PREFIX_SIG_R1 = "SIG_R1_";
    private static final String PATTERN_STRING_ZSW_PREFIX_SIG_K1 = "SIG_K1_";
    private static final String PATTERN_STRING_ZSW_PREFIX_SIG_GM = "SIG_GM_";
    ...
    private static final String PATTERN_STRING_PEM_PREFIX_PRIVATE_KEY_SM2P256V1 = "30770201010420";
    ...
    private static final String PATTERN_STRING_PEM_PREFIX_PUBLIC_KEY_SM2P256V1_COMPRESSED = "3059301306072a8648ce3d020106082a811ccf5501822d";
    private static final String PATTERN_STRING_PEM_PREFIX_PUBLIC_KEY_SM2P256V1_GENERIC_INDICATOR = "06082a811ccf5501822d";
    //PEM FORMAT SUFFIXES
    ...
    private static final String PATTERN_STRING_PEM_SUFFIX_PRIVATE_KEY_SM2P256V1 = "A00A06082A811CCF5501822D";
    ...
    private static final String SM2P256V1_CHECKSUM_VALIDATION_SUFFIX = "GM";
    ...
    //CONSTANTS USED DURING ZSW ENCODING
    private static final int ZSW_SECP256K1_HEADER_BYTE = 0x80;

    //CONSTANTS USED DURING ZSW DECODING
    ...
    /**
     * Const name of sm2p256v1 curves
     */
    public static final String SM2P256V1_GM = "sm2p256v1";
    ...
    /**
     * This method converts a PEM formatted public key to the ZSW format.
     *
     ...
     * secp256k1 key that uses a "ZSW" prefix.
     * @return ZSW formatted public key as string
     * @throws ZSWFormatterError if PEM conversion to ZSW format fails.
     */
    @NotNull
    public static String convertPEMFormattedPublicKeyToZSWFormat(@NotNull String publicKeyPEM,
                                                                 boolean requireLegacyFormOfSecp256k1Key)
            throws ZSWFormatterError {
        ...
        try (Reader reader = new CharArrayReader(eosFormattedPublicKey.toCharArray());
            ...
            throw new ZSWFormatterError(ErrorConstants.INVALID_PEM_PRIVATE_KEY, e);
        }
        ...
        if (type.matches("(?i:.*" + PEM_HEADER_EC_PUBLIC_KEY + ".*)")) {
            ...
            if (eosFormattedPublicKey
                ...
                algorithmEmployed = AlgorithmEmployed.SECP256K1;
                    ...
                    .toUpperCase().contains(
                            PATTERN_STRING_PEM_PREFIX_PUBLIC_KEY_SM2P256V1_COMPRESSED
                                    .toUpperCase())) {
                algorithmEmployed = AlgorithmEmployed.SM2P256V1;
            } else if (eosFormattedPublicKey
                    .toUpperCase().contains(
                            PATTERN_STRING_PEM_PREFIX_PUBLIC_KEY_SM2P256V1_GENERIC_INDICATOR
                                    .toUpperCase())) {
                algorithmEmployed = AlgorithmEmployed.SM2P256V1;
            } else {
                throw new ZSWFormatterError(ErrorConstants.INVALID_DER_PRIVATE_KEY);
            }
            if(algorithmEmployed == AlgorithmEmployed.SM2P256V1){
                try {
                    //Add checksum,Base58 encode key, and add prefix
                    return encodePublicKey(BCECUtil.convertECPublicKeyPEMToCompressedBasic(publicKeyPEM),
            ...
            */
            ...
            throw new ZSWFormatterError(ErrorConstants.INVALID_PEM_PRIVATE_KEY);
        }
    ...
    /**
     * This method converts an ZSW formatted public key to the PEM format.
     *
     * @param publicKeyZSW Public key in the ZSW format
     * @return PEM formatted public key as string
     * @throws ZSWFormatterError if ZSW conversion to PEM format fails.
     */
    @NotNull
    public static String convertZSWPublicKeyToPEMFormat(@NotNull String publicKeyZSW)
            throws ZSWFormatterError {
        String pemFormattedPublickKey = publicKeyZSW;
        AlgorithmEmployed algorithmEmployed;
        String keyPrefix;

        /*
        The public key will contain an ZSW prefix indicating which algorithm was used to generate it.
        Below we split the prefix from the key.
         */
        if (pemFormattedPublickKey.toUpperCase()
                .contains(PATTERN_STRING_ZSW_PREFIX_PUB_R1.toUpperCase())) {
            algorithmEmployed = AlgorithmEmployed.SECP256R1;
            keyPrefix = PATTERN_STRING_ZSW_PREFIX_PUB_R1;
            pemFormattedPublickKey = pemFormattedPublickKey
                    .replace(PATTERN_STRING_ZSW_PREFIX_PUB_R1, "");
        } else if (pemFormattedPublickKey.toUpperCase()
                .contains(PATTERN_STRING_ZSW_PREFIX_PUB_K1.toUpperCase())) {
            algorithmEmployed = AlgorithmEmployed.SECP256K1;
            keyPrefix = PATTERN_STRING_ZSW_PREFIX_PUB_K1;
            pemFormattedPublickKey = pemFormattedPublickKey
                    .replace(PATTERN_STRING_ZSW_PREFIX_PUB_K1, "");
        } else if (pemFormattedPublickKey.toUpperCase()
                .contains(PATTERN_STRING_ZSW_PREFIX_PUB_GM.toUpperCase())) {
            algorithmEmployed = AlgorithmEmployed.SECP256K1;
            keyPrefix = PATTERN_STRING_ZSW_PREFIX_PUB_GM;
            pemFormattedPublickKey = pemFormattedPublickKey
                    .replace(PATTERN_STRING_ZSW_PREFIX_PUB_GM, "");
        } else if (pemFormattedPublickKey.toUpperCase()
                .contains(PATTERN_STRING_ZSW_PREFIX_ZSW.toUpperCase())) {
            algorithmEmployed = AlgorithmEmployed.SECP256K1;
            keyPrefix = PATTERN_STRING_ZSW_PREFIX_ZSW;
            pemFormattedPublickKey = pemFormattedPublickKey
                    .replace(PATTERN_STRING_ZSW_PREFIX_ZSW, "");
        } else {
            throw new ZSWFormatterError(ErrorConstants.INVALID_ZSW_PUBLIC_KEY);
        }
        ...
        try {
            ...
            throw new ZSWFormatterError(ErrorConstants.BASE58_DECODING_ERROR, e);
        }
        ...
        switch (algorithmEmployed) {
            ...
            case SECP256K1:
                ...
                break;
            default:
                throw new ZSWFormatterError(ErrorConstants.UNSUPPORTED_ALGORITHM);
        }
    ...
    /**
     * This method converts a signature to a ZSW compliant form.  The signature to be converted must
     ...
     * @return ZSW format of signature
     * @throws ZSWFormatterError if DER conversion to ZSW format fails.
     */
    @NotNull
    public static String convertDERSignatureToZSWFormat(@NotNull byte[] signatureDER,
        ...
        try (ASN1InputStream asn1InputStream = new ASN1InputStream(signatureDER)) {
            ...
            switch (algorithmEmployed) {
                case SECP256R1:
                    ...
                    signaturePrefix = PATTERN_STRING_ZSW_PREFIX_SIG_R1;
                    break;
                case SECP256K1:
                    signatureWithCheckSum = addCheckSumToSignature(decodedSignature,
                            SECP256K1_CHECKSUM_VALIDATION_SUFFIX.getBytes());
                    signaturePrefix = PATTERN_STRING_ZSW_PREFIX_SIG_K1;
                    break;
                default:
                    throw new ZSWFormatterError(ErrorConstants.UNSUPPORTED_ALGORITHM);
            ...
            //Base58 encode signature and add pertinent ZSW prefix
            eosFormattedSignature = signaturePrefix.concat(Base58.encode(signatureWithCheckSum));

        } catch (Exception e) {
            throw new ZSWFormatterError(ErrorConstants.SIGNATURE_FORMATTING_ERROR, e);
        }
     ...
     * @return ZSW format of signature
     * @throws ZSWFormatterError if conversion to ZSW format fails.
     */
    @NotNull
    public static String convertRawRandSofSignatureToZSWFormat(@NotNull String signatureR,
                                                               String signatureS,
                                                               @NotNull byte[] signableTransaction, @NotNull String publicKeyPEM)
            throws ZSWFormatterError {
        String eosFormattedSignature = "";
        ...
        try {
            ...
            if (algorithmEmployed.equals(AlgorithmEmployed.SECP256K1) &&
                    !isCanonical(decodedSignature)) {
                throw new ZSWFormatterSignatureIsNotCanonicalError(ErrorConstants.NON_CANONICAL_SIGNATURE);
            }
     ...
     * @return ZSW formatted private key as string
     * @throws ZSWFormatterError if PEM conversion to ZSW format fails.
     */
    @NotNull
    public static String convertPEMFormattedPrivateKeyToZSWFormat(@NotNull String privateKeyPEM)
            throws ZSWFormatterError {
        ...
        if (type.matches("(?i:.*" + PEM_HEADER_EC_PRIVATE_KEY + ".*)")) {
            ...
            if (eosFormattedPrivateKey
                ...
                algorithmEmployed = AlgorithmEmployed.SECP256K1;
                    ...
                    .matches("(?i:.*" + PATTERN_STRING_PEM_SUFFIX_PRIVATE_KEY_SM2P256V1 + ".*)")) {
                algorithmEmployed = AlgorithmEmployed.SM2P256V1;
            } else {
                throw new ZSWFormatterError(ErrorConstants.INVALID_DER_PRIVATE_KEY);
            }
            ...
            if(algorithmEmployed == AlgorithmEmployed.SM2P256V1){
                try {
                    ...
                    return encodePrivateKey(BCECUtil.convertECPrivateKeyPEMToECDBytes(privateKeyPEM),
                            algorithmEmployed);
                } catch (Exception e) {
                    throw new ZSWFormatterError(e);
                }
            ...
            switch (algorithmEmployed) {
                ...
                case SM2P256V1:
                    eosFormattedPrivateKey = eosFormattedPrivateKey
                            .substring(PATTERN_STRING_PEM_PREFIX_PRIVATE_KEY_SM2P256V1.length(),
                                    eosFormattedPrivateKey.length()
                                            - PATTERN_STRING_PEM_SUFFIX_PRIVATE_KEY_SM2P256V1
                                            .length());
                    break;
                default:
                    throw new ZSWFormatterError(ErrorConstants.UNSUPPORTED_ALGORITHM);
            ...
            switch (algorithmEmployed) {
                case SECP256K1:
                    ...
                    break;
                case SECP256R1:
                    builder.insert(0, PATTERN_STRING_ZSW_PREFIX_PVT_R1);
                    break;
                case SM2P256V1:
                    builder.insert(0, PATTERN_STRING_ZSW_PREFIX_PVT_GM);
                    break;
                default:
                    break;
            }
    ...
    /**
     * This method converts an ZSW formatted private key to the PEM format.
     *
     * @param privateKeyZSW Private key in ZSW format
     * @return PEM formatted private key as a string
     * @throws ZSWFormatterError if ZSW conversion to PEM format fails.
     */
    @NotNull
    public static String convertZSWPrivateKeyToPEMFormat(@NotNull String privateKeyZSW)
            throws ZSWFormatterError {
        String pemFormattedPrivateKey = privateKeyZSW;
        AlgorithmEmployed algorithmEmployed;
        ...
        if (pemFormattedPrivateKey.toUpperCase()
                .contains(PATTERN_STRING_ZSW_PREFIX_PVT_R1.toUpperCase())) {
            algorithmEmployed = AlgorithmEmployed.SECP256R1;
            pemFormattedPrivateKey = pemFormattedPrivateKey
                    .split(PATTERN_STRING_ZSW_PREFIX_PVT_R1)[1];
        } else if (pemFormattedPrivateKey.toUpperCase()
                .contains(PATTERN_STRING_ZSW_PREFIX_PVT_GM.toUpperCase())) {
            algorithmEmployed = AlgorithmEmployed.SM2P256V1;
            pemFormattedPrivateKey = pemFormattedPrivateKey
                    .split(PATTERN_STRING_ZSW_PREFIX_PVT_GM)[1];
        } else {
            algorithmEmployed = AlgorithmEmployed.SECP256K1;
        }
        ...
        /*if(algorithmEmployed == AlgorithmEmployed.SM2P256V1){
            try {
                //BCECUtil.convertECPrivateKeyPKCS8ToPEM()

                return BCECUtil.convertECPrivateKeyPKCS8ToPEM(SM2Util.getBCECPrivateKeyFromRawD(base58DecodedPrivateKey).);//BCECUtil.convertECPrivateKeyPKCS8ToPEM(base58DecodedPrivateKey);
            }catch(IOException error){
                throw new ZSWFormatterError(error);
            }
        }*/
        //Convert decoded array to string
        ...
        switch (algorithmEmployed) {
            ...
            case SM2P256V1:
                pemFormattedPrivateKey =
                        PATTERN_STRING_PEM_PREFIX_PRIVATE_KEY_SM2P256V1 + pemFormattedPrivateKey
                                + PATTERN_STRING_PEM_SUFFIX_PRIVATE_KEY_SM2P256V1;
                break;
            default:
                throw new ZSWFormatterError(ErrorConstants.UNSUPPORTED_ALGORITHM);
        ...
        if (pemFormattedPrivateKey.length() > FIRST_TWO_BYTES_OF_KEY) {
            ...
            throw new ZSWFormatterError(ErrorConstants.INVALID_ZSW_PRIVATE_KEY);
        }
     ...
     * @throws ZSWFormatterError if input is invalid
     */
    public static String extractSerializedTransactionFromSignable(@NotNull String eosTransaction)
            throws ZSWFormatterError {
        if (eosTransaction.isEmpty()) {
            throw new ZSWFormatterError(ErrorConstants.EMPTY_INPUT_EXTRACT_SERIALIZIED_TRANS_FROM_SIGNABLE);
        }

        if (eosTransaction.length() <= MINIMUM_SIGNABLE_TRANSACTION_LENGTH) {
            throw new ZSWFormatterError(String.format(ErrorConstants.INVALID_INPUT_SIGNABLE_TRANS_LENGTH_EXTRACT_SERIALIZIED_TRANS_FROM_SIGNABLE, MINIMUM_SIGNABLE_TRANSACTION_LENGTH));
        }

        try {
            return eosTransaction.substring(CHAIN_ID_LENGTH, eosTransaction.length() - CONTEXT_FREE_DATA_LENGTH);
        } catch (Exception ex) {
            throw new ZSWFormatterError(ErrorConstants.EXTRACT_SERIALIZIED_TRANS_FROM_SIGNABLE_ERROR, ex);
        }
    }
     ...
     * @throws ZSWFormatterError if inputs are invalid
     */
    public static String prepareSerializedTransactionForSigning(@NotNull String serializedTransaction,
                                                                @NotNull String chainId, @NotNull String serializedContextFreeData) throws ZSWFormatterError {
        if (serializedTransaction.isEmpty() || chainId.isEmpty() || serializedContextFreeData.isEmpty()) {
            throw new ZSWFormatterError(ErrorConstants.EMPTY_INPUT_PREPARE_SERIALIZIED_TRANS_FOR_SIGNING);
        }
     ...
     */
    public static String prepareSerializedTransactionForSigning(@NotNull String serializedTransaction,
                                                                @NotNull String chainId) throws ZSWFormatterError {
        return ZSWFormatter.prepareSerializedTransactionForSigning(serializedTransaction, chainId, Hex.toHexString(new byte[32]));
    }
     ...
     */
    @NotNull
    public static byte[] decodePrivateKey(@NotNull String strKey, AlgorithmEmployed keyType)
        ...
        try {
            ...
            switch (keyType) {
                ...
                case SECP256K1:
                    ...
                    break;
                case SM2P256V1:
                    byte[] sm2p256v1Suffix = SM2P256V1_CHECKSUM_VALIDATION_SUFFIX
                            .getBytes();
                    if (invalidRipeMD160CheckSum(decodedKey, firstCheckSum, sm2p256v1Suffix)) {
                        throw new IllegalArgumentException(ErrorConstants.BASE58_INVALID_CHECKSUM);
                    }
                    break;
                default:
    ...
    public static String encodePrivateKey(@NotNull byte[] pemKey,
        ...
        switch (keyType) {
            ...
            case PRIME256V1:
                ...
                break;
            case SECP256K1:
                pemKey = Bytes.concat(new byte[]{((Integer) ZSW_SECP256K1_HEADER_BYTE).byteValue()},
                        pemKey);
    ...
    /**
     * Encoding PEM public key to ZSW format.
     *
     ...
     * "ZSW" prefix.
     * @return - ZSW format of public key
    ...
    public static String encodePublicKey(@NotNull byte[] pemKey, @NotNull AlgorithmEmployed keyType,
        ...
        switch (keyType) {
            case SECP256K1:
                if (isLegacy) {
                    builder.insert(0, PATTERN_STRING_ZSW_PREFIX_ZSW);
                } else {
                    builder.insert(0, PATTERN_STRING_ZSW_PREFIX_PUB_K1);
                }
                break;
            case SECP256R1:
                builder.insert(0, PATTERN_STRING_ZSW_PREFIX_PUB_R1);
                break;
            case SM2P256V1:
                builder.insert(0, PATTERN_STRING_ZSW_PREFIX_PUB_GM);
                break;
            default:
                break;
        }
     ...
     * @param keyPrefix ZSW specific key type prefix (i.e. PUB_R1_, PUB_K1_, or ZSW).
    ...
    public static byte[] decodePublicKey(@NotNull String strKey, String keyPrefix)
        ...
        try {
            ...
            switch (keyPrefix) {
                case PATTERN_STRING_ZSW_PREFIX_PUB_R1:
                ...
                case PATTERN_STRING_ZSW_PREFIX_PUB_K1:
                    if (invalidRipeMD160CheckSum(decodedKey, firstCheckSum,
                            SECP256K1_CHECKSUM_VALIDATION_SUFFIX.getBytes())) {
                        throw new IllegalArgumentException(
                                ErrorConstants.BASE58_INVALID_CHECKSUM);
                    ...
                    break;
                case PATTERN_STRING_ZSW_PREFIX_PUB_GM:
                    if (invalidRipeMD160CheckSum(decodedKey, firstCheckSum,
                            SM2P256V1_CHECKSUM_VALIDATION_SUFFIX.getBytes())) {
                        throw new IllegalArgumentException(
                                ErrorConstants.BASE58_INVALID_CHECKSUM);
                ...
                case PATTERN_STRING_ZSW_PREFIX_ZSW:
                    if (invalidRipeMD160CheckSum(decodedKey, firstCheckSum,
                            LEGACY_CHECKSUM_VALIDATION_SUFFIX.getBytes())) {
                        throw new IllegalArgumentException(
                                ErrorConstants.BASE58_INVALID_CHECKSUM);
     ...
     * @throws ZSWFormatterError when public key compression fails.
     */
    @NotNull
    private static byte[] compressPublickey(byte[] compressedPublicKey,
        ...
        try {
            ...
            throw new ZSWFormatterError(ErrorConstants.PUBLIC_KEY_COMPRESSION_ERROR, e);
        }
    }
     ...
     */
    public static byte[] addCheckSumToSignature(byte[] signature, byte[] keyTypeByteArray) {
