...
public class ZSWItemsMakeItemTemplate implements Serializable{
    ...
    public ZSWItemsMakeItemTemplate(@NotNull String authorizer, @NotNull String creator, @NotNull String zsw_id, @NotNull String item_template_id, @NotNull String collection_id, @NotNull int item_type, @NotNull String schema_name, @NotNull ZSWAPIV1.KVPair[] immutable_metadata, @NotNull String item_external_metadata_url_template) {
