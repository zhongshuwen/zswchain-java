...
public class GetInfoResponse {
     ...
     * call:  {@link org.zhongshuwen.zswjava.utilities.ZSWFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     */
     ...
     * org.zhongshuwen.zswjava.interfaces.IRPCProvider#getBlock(GetBlockRequest)} at {@link
     * org.zhongshuwen.zswjava.session.TransactionProcessor#prepare(List)}
     */
     ...
     * Transaction#setExpiration(String)}} at {@link org.zhongshuwen.zswjava.session.TransactionProcessor#prepare(List)}
     */
     ...
     * org.zhongshuwen.zswjava.utilities.ZSWFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     *
     * @return the chain id.
     */
     ...
     * org.zhongshuwen.zswjava.interfaces.IRPCProvider#getBlockInfo(GetBlockInfoRequest)} at {@link
     * org.zhongshuwen.zswjava.session.TransactionProcessor#prepare(List)}
